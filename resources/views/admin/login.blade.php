        ...
        <h1 class="font-bold text-center text-2xl mb-5">Your Logo</h1>
            ...
            <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                ...
                <form action="{{ route('admin.login') }}" method="post">
                    @csrf
                <div class="px-5 py-7">
                <label class="font-semibold text-sm text-gray-600 pb-1 block">Adresse email</label>
                ...
                <div class="flex -mx-3">
                    <div class="w-full px-3 mb-5">
                        <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">CONNEXION</button>
                    </div>
                </div>
            </form>
                </div>
                ...
                <div class="grid grid-cols-2 gap-1">
                    ...
                    <button class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                        ...
                        <span class="inline-block ml-1">avez vous oubliez votre mot de passe?</span>
                    </button>
                    </div>
                    ...
                    <button class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                        ...
                        <span class="inline-block ml-1">besoin d'aide ?</span>
                    </button>
                    </div>
                </div>
                </div>
