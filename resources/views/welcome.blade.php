                        ...
                        <div class="m-16">
                            @if (Route::has('login'))
                                <div>
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-gray-500">Connexion</a>

                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline dark:text-gray-500">S'inscricre</a>
                                        @endif
                                    @endauth
                                </div>
                            @endif
                    ...
                    <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                        ...
                        <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('{{ asset($article->photo) }}')">
                                <a href="{{ route("dashboard") }}" class="p-2 rounded-full bg-blue-600 text-white mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                                  Commander
                                </a>
                            </div>
                            <div class="px-5 py-3">
